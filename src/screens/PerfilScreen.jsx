...
import { ScreenScaffold, SoftCard, SoftIcon, SectionTitle, Divider } from '../components/CahuinUI';
      ...
      <Modal visible={modalArticuloVisible} animationType="slide" transparent={false}>
        <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.bg }}>
          ...
          <ScrollView contentContainerStyle={styles.articleModalBody}>
            {articuloActivo?.icon && <Ionicons name={articuloActivo.icon} size={52} color={COLORS.primario} style={{marginBottom: 15}} />}
...
const getStyles = (COLORS) => StyleSheet.create({
  ...
  // ── Stats Row ──
  statsRow: { flexDirection: 'row', gap: SPACING[3], marginBottom: SPACING[1] },
  statPill: { flex: 1, flexDirection: 'row', alignItems: 'center', paddingVertical: SPACING[2], gap: 12 },
  ...
  questionRow: { flexDirection: 'row', alignItems: 'center', gap: SPACING[2], backgroundColor: 'transparent', paddingVertical: SPACING[3], borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: COLORS.border },
  ...
  answeredBox: { backgroundColor: 'transparent', paddingVertical: SPACING[3], borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: COLORS.border },
  ...
  testButton: { flex: 1, minHeight: 72, backgroundColor: 'transparent', paddingVertical: SPACING[2], justifyContent: 'center', alignItems: 'center' },
  ...
  cancelButton: { flex: 1, minHeight: 50, borderRadius: 16, backgroundColor: 'rgba(150,150,150,0.1)', alignItems: 'center', justifyContent: 'center' },
