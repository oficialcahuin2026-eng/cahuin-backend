  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        <Text style={styles.titulo}>Las reglas del Cahuín 🌶️</Text>
        ...
        <Text style={styles.subtitulo}>4. Suscripción Premium y Cahuines</Text>
        <Text style={styles.parrafo}>
          Cahuín ofrece compras dentro de la app (como enviar regalos virtuales o adquirir la membresía Premium). Estas compras son definitivas y no reembolsables, salvo que la ley chilena (SERNAC) exija lo contrario por fallos del servicio.
        </Text>
